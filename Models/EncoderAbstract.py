...
class EncoderAbstract(ModelAbstract):
    ...
    def correctFromFile(self, src: str, target: str = None, output_dir: str = "outputs", evaluate_flag: bool = False):
        import pandas as pd
        """
        ...
        return self.correct(src, target, output_dir, evaluate_flag)
